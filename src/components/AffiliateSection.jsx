...
const PARTNERS = [
  { name: "Binance", tagline: "World's Largest Exchange", desc: "Zero-fee DCA into Bitcoin. Set up automatic recurring buys.", cta: "Start DCA on Binance →", url: "https://www.binance.com/en/register?ref=CPA_00MN0NP3QD", badge: "Most Popular", badgeColor: "bg-yellow-500/20 text-yellow-400 border border-yellow-500/30", icon: "🟡", why: "Best for: Regular DCA buyers" },
  { name: "Coinbase", tagline: "Most Trusted US Exchange", desc: "Regulated, insured, beginner-friendly. Perfect for first-time BTC buyers.", cta: "Get $10 Free on Coinbase →", url: "https://coinbase.com/join/bearmarketclock", badge: "Beginner Friendly", badgeColor: "bg-blue-500/20 text-blue-400 border border-blue-500/30", icon: "👍", why: "Best for: US users, beginners" },
  { name: "Ledger", tagline: "Hardware Wallet #1", desc: "Not your keys, not your coins. Keep your BTC safe from exchange hacks.", cta: "Secure Your Bitcoin →", url: "https://shop.ledger.com/pages/ledger-nano-x?r=bearmarketclock", badge: "Security Essential", badgeColor: "bg-purple-500/20 text-purple-400 border border-purple-500/30", icon: "🔐", why: "Best for: Long-term HODLers" },
  { name: "TradingView", tagline: "Pro Charts & Analysis", desc: "Track Bitcoin's bear market recovery in real-time with professional charting tools.", cta: "Get TradingView Pro →", url: "https://www.tradingview.com/gopro/?share_your_love=bearmarketclock", badge: "For Traders", badgeColor: "bg-green-500/20 text-green-400 border border-green-500/30", icon: "📈", why: "Best for: Active traders" },
];
