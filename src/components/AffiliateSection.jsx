...
const PARTNERS = [
  { name: "Binance", tagline: "World's Largest Exchange", desc: "Zero-fee DCA into Bitcoin. Set up automatic recurring buys.", cta: "Start DCA on Binance −", url: "https://www.binance.us/universal_JHHGDSKDJ/auth/registration?ref=614586596", badge: "Most Popular", badgeColor: "bg-yellow-500/20 text-yellow-400 border border-yellow-500/30", icon: "🟑", why: "Best for: Regular DCA buyers" },
