...
const PARTNERS = [
  ...
  { name: "Ledger", tagline: "Hardware Wallet #1", desc: "Not your keys, not your coins. Keep your BTC safe from exchange hacks.", cta: "Secure Your Bitcoin →", url: "https://shop.ledger.com/?r=d70161b3e051", badge: "Security Essential", badgeColor: "bg-purple-500/20 text-purple-400 border border-purple-500/30", icon: "🔐", why: "Best for: Long-term HODLers" },
  { name: "TradingView", tagline: "Pro Charts & Analysis", desc: "Track Bitcoin's bear market recovery in real-time with professional charting tools.", cta: "Get TradingView Pro →", url: "https://www.tradingview.com/?aff_id=165580&source=bearmarketclock", badge: "For Traders", badgeColor: "bg-green-500/20 text-green-400 border border-green-500/30", icon: "📈", why: "Best for: Active traders" },
];
